...
func TestEmpty(t *testing.T) {
	block := Create(&FailDefn{}) // test with empty blocktype here
...
func TestEmptyTag(t *testing.T) {
	block := Create(&TagDefn{}) // test with struct initialised blocktype and class here
